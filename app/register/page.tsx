  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f8fafc', color:'#1e293b', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'sans-serif' }}>
      <div style={{ background:'#ffffff', border:'1px solid rgba(14,165,233,0.2)', borderRadius:16, padding:'40px 36px', width:'100%', maxWidth:400, boxShadow:'0 4px 24px rgba(15,23,42,0.06)' }}>
        <h1 style={{ color:'#1e293b', fontSize:24, fontWeight:800, marginBottom:8, textAlign:'center' }}>eVerify</h1>
        <p style={{ color:'rgba(30,41,59,0.6)', textAlign:'center', marginBottom:32, fontSize:14 }}>Creeaza un cont gratuit</p>
        ...
        <div style={{ marginBottom:16 }}>
          ...
          <input value={email} onChange={e=>setEmail(e.target.value)} type='email' placeholder='adresa@email.ro' style={{ width:'100%', background:'rgba(30,41,59,0.04)', border:'1px solid rgba(14,165,233,0.2)', borderRadius:10, padding:'11px 14px', color:'#1e293b', fontSize:14, outline:'none', fontFamily:'sans-serif' }} />
        </div>
