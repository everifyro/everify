...
const SCAM_TYPES = [
  DEFAULT_TYPE,
  'Phishing / email fals',
  'SMS fals (mesaj înșelător)',
  'Apel telefonic fals (cineva se dă drept bancă/poliție)',
  'Inspector bancar fals',
  'Arest digital fals',
  'Site fals / magazin online fals',
  'Ofertă de muncă falsă',
  'Investiții false / criptomonede',
  'Romantic scam / escrocherie sentimentală',
  'Loterie / câștig fals',
  'Fraudă marketplace (OLX, Facebook)',
  'Fraudă cu criptomonede',
  'SIM swap / furt număr de telefon',
  'Malware / virus / ransomware (software malițios)',
  'Altul',
]
